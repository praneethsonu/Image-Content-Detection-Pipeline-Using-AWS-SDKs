...
These titles reflect the integration of key AWS services such as S3, Lambda, and Rekognition, aligned with the described workflow.
...
3. Using Amazon Rekognition in our Lambda function to detect what is in the image we uploaded.
